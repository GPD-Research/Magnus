...
describe('equipment catalog', () => {
  ...
  it('organizes the scene catalog into the four planned categories', () => {
    ...
    expect(equipmentDefinition('ems-ambulance')).toMatchObject({ category: 'external-asset', glyph: 'ambulance' })
    expect(equipmentDefinition('ladder-truck')).toMatchObject({ category: 'external-asset', glyph: 'ladder-truck' })
